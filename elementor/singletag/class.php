...
class SingleTag extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'single tag', 'need tag', 'tag' );
	}
	...
	protected function render() {
		...
		$row             = $settings['row'];
		$rows            = $settings['rows'];
		$cat             = $settings['cat'] ? implode( $settings['cat'], array() ) : '';
		$tag             = $settings['tag'] ? implode( $settings['tag'], array() ) : '';
		$location        = $settings['location'] ? implode( $settings['location'], array() ) : '';
