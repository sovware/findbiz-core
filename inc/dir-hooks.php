...
class DirHooks {
	...
	public function __construct() {
		...
		self::$sign_in   = Helper::options()['sign_in'];
		self::$copyright = Helper::options()['copyright_area'];
	...
	public static function copyright() {
		...
		$text   = Helper::options()['copyright_text'];
		?>
	...
	public static function sign_modal() {
		$sign_in_text = Helper::options()['sign_in_text'];
